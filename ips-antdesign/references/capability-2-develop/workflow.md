...
2. Select an official component before writing a local abstraction. Query matching API and demos through [sources](../common/sources.md); route X/Charts queries to their own docs.
